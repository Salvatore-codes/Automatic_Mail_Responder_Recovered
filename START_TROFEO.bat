...
start "Trofeo - Web Server" cmd /k "color 0B && echo WEB SERVER STARTED - http://127.0.0.1:8080 && echo Press Ctrl+C to stop. && echo. && C:\Users\Admin\AppData\Local\Programs\Python\Python314\python.exe run_server.py"
